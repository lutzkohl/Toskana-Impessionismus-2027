...
(function(root,factory){
  if(typeof module==='object'&&module.exports)module.exports=factory(require('./instagram-core.js'),require('./selection-rules.js'),require('./wallpaper-core.js'),require('./photo-workshop-core.js'));
  else root.RoundCore=factory(root.InstagramCore,root.CalendarSelectionRules,root.WallpaperCore,root.PhotoWorkshopCore);
})(typeof globalThis!=='undefined'?globalThis:this,function(I,C,W,P){
  'use strict';
  const object=x=>!!x&&typeof x==='object'&&!Array.isArray(x);
  const clone=x=>JSON.parse(JSON.stringify(x));
  const emptyWorkflow=()=>({version:1,revision:0,skipped:[],completed:{},drafts:{},wallpapers:[],photo_crops:{},photo_reviews:{}});
  ...
  function validateBundle(raw,catalog,pool,sources,policy={}){
    ...
    Object.assign(workflow,P.validateExtras(w,pool));
