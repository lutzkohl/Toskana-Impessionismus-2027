...
(function(root,factory){if(typeof module==='object'&&module.exports)module.exports=factory();else root.WallpaperCore=factory();})(typeof globalThis!=='undefined'?globalThis:this,()=>{
  ...
  function preserveLegacy(bundle,current){const b=clone(bundle);if(b.workflow&&!Object.hasOwn(b.workflow,'wallpapers'))b.workflow.wallpapers=clone(current.wallpapers||[]);return b;}
