...
Unter `instagram/` lassen sich Originalfotos und gemalte Varianten nach Ort und Ausgangsfoto vormerken. Kalender und Titelseite markieren ihre verwendeten Ausgangsfotos; Restmotive und der Standardexport schließen diese aus. Die separate Instagram-Planung enthält optionale Monate und Notizen. Ein ZIP-Export bündelt ausgewählte JPEGs, Auswahl.json, Manifest.json und Planung.csv mit noch leeren Veröffentlichungsterminen. Es werden keine Beiträge veröffentlicht. Die Bilder sind unbeschnitten; das Beitragsformat wird später gewählt.
